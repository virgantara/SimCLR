...
class DeviceAwareTransform(nn.Module):
...
class BYOL(nn.Module):
    def __init__(
        ...
        DEFAULT_AUG_FN = lambda device: DeviceAwareTransform(torch.nn.Sequential(
            RandomApply(
                T.ColorJitter(0.8, 0.8, 0.8, 0.2),
                p = 0.3
            ),
        ...
        self.augment1 = default(augment_fn, DEFAULT_AUG_FN(device))
        ...
        self.online_predictor = self.online_predictor.to(device)
